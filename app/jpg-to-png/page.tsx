...
export default function JpgToPngPage() {
  ...
  const convertImage = async () => {
    ...
    await downloadConvertedFile({ endpoint: "/api/jpg-to-png", formData, fallbackFileName: "converted.png" });
  };
  ...
  return (
    <main className="max-w-4xl mx-auto p-10">
      ...
      >
        Convert JPG images to PNG format online for free.
      ...
      <ToolSeo
        ...
        description="
          Upload your JPG image, click Convert to PNG
          and download the converted file instantly.
          PNG format is ideal when you need lossless
