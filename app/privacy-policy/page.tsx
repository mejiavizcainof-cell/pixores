...
const sections: PolicySection[] = [
  ...
  { id: "cookies", title: "Cookies and Advertising", content: <><p>Pixores may use cookies and similar technologies for essential functionality, preferences, analytics, security, and advertising. Third-party vendors, including Google, may use cookies to serve ads based on a user&apos;s prior visits to Pixores or other websites. Google&apos;s use of advertising cookies enables Google and its partners to show ads based on those visits.</p><p>Users can manage personalized advertising through <a href="https://adssettings.google.com/" target="_blank" rel="noreferrer">Google Ads Settings</a>. See our <Link href="/cookie-policy">Cookie Policy</Link> for more information and browser control options.</p></> },
...
export default function PrivacyPolicyPage() {
  return <PolicyPage title="Privacy Policy" description="How Pixores handles account information, uploaded files, cookies, analytics, advertising, and third-party processing." lastUpdated="August 1, 2026" notice="Privacy is part of the product. We limit file processing to the operation requested and use local browser processing whenever the tool supports it." sections={sections} />;
}
