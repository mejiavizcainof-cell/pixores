...
const sections: PolicySection[] = [
  ...
  { id: "services", title: "Third-Party Services", content: <><p>Pixores may use providers such as Google Analytics and Google AdSense. Third-party vendors, including Google, may use cookies to serve, personalize, limit and measure ads based on prior visits to Pixores or other websites. These providers process device or usage information under their own privacy documentation.</p><p>You can manage personalized Google advertising through <a href="https://adssettings.google.com/" target="_blank" rel="noreferrer">Google Ads Settings</a>.</p></> },
...
export default function CookiePolicyPage() {
  return <PolicyPage title="Cookie Policy" description="How cookies and similar technologies support site functions, analytics, security, preferences, and advertising." lastUpdated="August 1, 2026" notice="You can manage cookies through your browser. Disabling essential storage may affect sign-in, saved preferences, and other site features." sections={sections} />;
}
